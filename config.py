...
# Full market scan cadence (seconds). ~300 = 5 min (was 600).
SCAN_INTERVAL_SEC = _env_int("SCAN_INTERVAL_SEC", "300")
...
# Resolved at runtime to live X-Perp; placeholder for imports
BTC_SYMBOL = _env("BTC_SYMBOL", "BTC/USD:USD-310404") or "BTC/USD:USD-310404"
BTC_DUMP_RSI_MAX = 28
